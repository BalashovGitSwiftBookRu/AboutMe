    ...
    static func getUser() -> User {
        User(
            ...
            person: Person(
                ...
                bio: "В прежней жизни я работал преподавателем в университете.\nВсегда нравились компьютеры, пользовался ими постоянно. А когда вышел первый iPhone захотел обязательно его купить. Потом перешел с Windows на Mac. И когда появился язык программирования Swift решил научиться писать на нем мобильные приложения. Изучаю программирование самостоятельно, это мой первый платный курс.\nВ свободное время люблю готовить что-нибудь вкусное и смотреть фильмы. Особенно нравятся боевики, дективы, приключения, фантастика, хорошие мелодрамы и конечно комедии."
            )
        )
    }
}
